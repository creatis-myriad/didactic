        ...
        if attr in [*TabularAttribute.categorical_attrs(), *list(categorical_attrs_lists)]:
            ...
            with sns.axes_style("darkgrid"):
                for legend_entry in plot.legend().texts:
                    entry_text = legend_entry.get_text()
                    if entry_text in TABULAR_ATTR_TITLES:
                        legend_entry.set_text(TABULAR_ATTR_TITLES[entry_text])
                    if entry_text in legend_groups_count:
                        legend_entry.set_text(f"{entry_text} (n={legend_groups_count[entry_text]})")
